...
export default async function ArrivingPage({
  params,
}: {
    ...
    <main className="min-h-screen">
      ...
      <section className="mx-auto max-w-6xl px-4 py-10 sm:px-6">
        ...
        <h1 className="mt-3 text-3xl font-bold tracking-tight text-white">
          {program.name} award space arriving {code}
        </h1>
        <p className="mt-2 text-slate-400">
          All recently-seen {program.name} award flights arriving into {code}, from anywhere.
        </p>
        <ExploreTable source={source} destAirport={code} />
      </section>
    </main>
  );
}
